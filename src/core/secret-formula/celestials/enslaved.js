export const enslaved = {
  ...
  progress: {
    ...
    c10: {
      id: 4,
      hint: "Is there a way to get Antimatter Galaxies without 9th Antimatter Dimensions?",
      condition: "Used Challenge 11 to get more than one Antimatter Galaxy with 7th Antimatter Dimensions",
    },
    secretStudy: {
      id: 5,
