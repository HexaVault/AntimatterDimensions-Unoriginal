...
export const normalChallenges = [
  ...
  },
  {
    ...
    legacyId: 13,
    isQuickResettable: false,
    description: () => `Dimension Boosts provide no multiplier, and Tickspeed cannot be bought, but the multiplier for purchasing ${formatInt(10)} of an Antimatter Dimension is increased ${formatX(3)}`,
    name: "9th Antimatter Dimension Autobuyer",
    reward: "Upgradeable 9th Antimatter Dimension Autobuyer",
    lockedAt: DC.D0,
  },
  {
    id: 10,
