...
export const normalAchievements = [
  ...
  },
  {
    ...
    description: "Buy a 6th Antimatter Dimension.",
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    id: 17,
    ...
    get description() {
      return Enslaved.isRunning
        ? "Buy a 7th Antimatter Dimension (they never amount to anything)"
        : "Buy a 7th Antimatter Dimension.";
    },
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    ...
    description: "Buy an 8th Antimatter Dimension.",
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    id: 19,
    ...
    get description() {
      return Enslaved.isRunning
        ? "Buy an 9th Antimatter Dimension (don't get used to it)"
        : "Buy an 9th Antimatter Dimension.";
    },
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
  ...
  {
    id: 23,
    name: "The 10th Dimension is a lie",
    get description() { return `Have exactly ${formatInt(99)} 9th Antimatter Dimensions.`; },
    checkRequirement: () => AntimatterDimension(9).amount.eq(99),
    get reward() { return `9th Antimatter Dimensions are ${formatPercents(0.1)} stronger.`; },
    effect: 1.1
  },
  {
    id: 24,
  ...
  },
  {
    ...
    description: "Infinity without having any 9th Antimatter Dimensions.",
    checkRequirement: () => AntimatterDimension(9).totalAmount.eq(0),
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Dimensions 1-8 are ${formatPercents(0.02)} stronger.`; },
    effect: 1.02
  },
  {
    id: 35,
  ...
  },
  {
    ...
    name: "Fraud",
    get description() {
      return `Reach ${formatInt(10)} Infinity Points`;
    },
    checkRequirement: () => player.infinityPoints.gte(10),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 41,
  ...
  },
  {
    ...
    description:
      "Get the 9th Antimatter Dimension multiplier to be highest, 8th Antimatter Dimension multiplier " +
      " second highest, etc.",
    checkRequirement: () => {
      const multipliers = Array.range(1, 9).map(tier => AntimatterDimension(tier).multiplier);
  ...
  },
  {
    id: 48,
    name: "Antichallenged",
    get description() { return `Complete all ${formatInt(13)} Normal Challenges.`; },
  ...
  },
  {
    ...
    checkRequirement: () => NormalChallenge(10).isOnlyActiveChallenge && Time.thisInfinityRealTime.totalMinutes <= 3,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
  ...
  },
  {
    ...
    get description() { return `Play for ${formatInt(9)} days.`; },
    checkRequirement: () => Time.totalTimePlayed.totalDays >= 9,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    get description() {
      ...
      ${format(1e10)} times higher Infinity Points than the previous one.`;
    },
    checkRequirement: () => {
      ...
      for (let i = 0; i < infinities.length - 1; i++) {
        if (infinities[i].lt(infinities[i + 1].times(1e10))) return false;
      }
      return true;
    },
    checkEvent: GAME_EVENT.BIG_CRUNCH_AFTER,
  ...
  {
    id: 89,
    name: "This is an original Achievement",
    get description() {
      return `Big Crunch for ${format(DC.E140)} Infinity Points in ${formatInt(250)} miliseconds or less.`;
    },
    checkRequirement: () => gainedInfinityPoints().exponent >= 140 && Time.thisInfinityRealTime.totalMilliseconds <= 250,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
  },
  {
    id: 91,
  ...
  {
    id: 99,
    name: "We were already at infinity?",
    description: "Unlock the 9th Infinity Dimension.",
    checkRequirement: () => InfinityDimension(9).isUnlocked,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 101,
  ...
  },
  {
    ...
    description: "Eternity without buying Antimatter Dimensions 2-9.",
  ...
  {
    id: 129,
    name: "Eternal Termoil",
    get description() { return `Reach ${formatInt(55000)} Free Tickspeed Upgrades`; },
    checkRequirement: () => player.totalTickGained >= 55000,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 131,
  ...
  {
    id: 139,
    name: "Galactic Awakening",
    get description() {
      return `Reach ${formatInt(1150)} total galaxies (Tachyon, Replicated and Antimatter).`;
    },
    checkRequirement: () => player.galaxies + player.replicanti.galaxies + player.dilation.totalTachyonGalaxies >= 1150,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 141,
  ...
  },
  {
    id: 149,
    name: "#startbestperk",
    description: "Reality without any automatic achievements",
  ...
  },
  {
    ...
    get description() {
      ...
      buying 9th Antimatter Dimensions in your current Infinity.`;
    },
  ...
  {
    id: 159,
    name: "Stuck in the 4th dimension",
    description: "Purchase a tesseract",
    checkRequirement: () => player.celestials.enslaved.tesseracts > 0,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 161,
  ...
  {
    id: 169,
    name: "Penteracts when?",
    get description() {
       return `Purchase ${formatInt(5)} Tesseracts`;
    },
    checkRequirement: () => player.celestials.enslaved.tesseracts >= 5,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 171,
  ...
  },
  {
    id: 179,
    name: "This is stupid",
    get description() { return `Reach ${formatPostBreak(new Decimal("1e6460000"))} IP while in Effarig Reality, Dilated, with no Glyphs equipped, no Time Studies and no Infinity Dimensions.`; },
    checkRequirement: () => player.celestials.effarig.run && Currency.infinityPoints.gte("1e6460000") && player.timestudy.studies.length === 0 && player.dilation.active && player.dimensions.infinity[0].amount.eq(0) && Glyphs.activeWithoutCompanion.length === 0,
    checkEvent: GAME_EVENT.GALAXY_RESET_AFTER,
  },
  {
    id: 181,
  ...
  },
  {
    id: 188,
    displayId: 999,
    name: "And so they fall...",
    description: "Unlock the galaxy generator",
    checkRequirement: () => PelleStrikes.eternity._config.rift().milestones[2].lastChecked,
    checkEvent: GAME_EVENT.PELLE_STRIKE_UNLOCKED,
  },
  {
    id: 189,
